...
4. Resolve contract ABIs and build table schemas (no `CREATE TABLE`, no discovery, no
   freeze reconciliation)
5. Start the REST API server
6. On a timer (`--refresh-interval`), re-read dynamic contracts from the store and
